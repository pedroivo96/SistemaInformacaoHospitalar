  ...
  <body>
	...
	<div class="row mb-5 mt-5">
		<div class="col-md-12 border" align="center">
			...
			<?php
				...
				$sql = 'SELECT * FROM diagnosticos WHERE cpfprofissional = :cpfprofissional';
				...
				if($count > 0){
					...
					<div class="alert alert-warning" role="alert">
						Você não tem diagnósticos cadastrados.
					</div>
					<?php
				}
			?>
	...
	<div class="row">
		...
		<div class="col-md-4">
			...
			<button type="button" class="btn btn-primary btn-lg btn-block" onclick="location.href = 'diagnosticosEnfermeiro.php';">Meus diagnósticos</button>
